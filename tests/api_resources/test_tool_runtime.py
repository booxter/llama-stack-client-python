...
class TestToolRuntime:
    ...
    @parametrize
    def test_method_discover_tools(self, client: LlamaStackClient) -> None:
        tool_runtime = client.tool_runtime.discover_tools(
            tool_group={
                "endpoint": {"uri": "uri"},
    ...
    @parametrize
    def test_method_discover_tools_with_all_params(self, client: LlamaStackClient) -> None:
        tool_runtime = client.tool_runtime.discover_tools(
            tool_group={
                "endpoint": {"uri": "uri"},
                "type": "model_context_protocol",
    ...
    @parametrize
    def test_raw_response_discover_tools(self, client: LlamaStackClient) -> None:
        response = client.tool_runtime.with_raw_response.discover_tools(
            tool_group={
                "endpoint": {"uri": "uri"},
                "type": "model_context_protocol",
            },
    ...
    @parametrize
    def test_streaming_response_discover_tools(self, client: LlamaStackClient) -> None:
        with client.tool_runtime.with_streaming_response.discover_tools(
            tool_group={
                "endpoint": {"uri": "uri"},
                "type": "model_context_protocol",
            },
...
class TestAsyncToolRuntime:
    ...
    @parametrize
    async def test_method_discover_tools(self, async_client: AsyncLlamaStackClient) -> None:
        tool_runtime = await async_client.tool_runtime.discover_tools(
            tool_group={
                "endpoint": {"uri": "uri"},
                "type": "model_context_protocol",
            },
    ...
    @parametrize
    async def test_method_discover_tools_with_all_params(self, async_client: AsyncLlamaStackClient) -> None:
        tool_runtime = await async_client.tool_runtime.discover_tools(
            tool_group={
                "endpoint": {"uri": "uri"},
                "type": "model_context_protocol",
    ...
    @parametrize
    async def test_raw_response_discover_tools(self, async_client: AsyncLlamaStackClient) -> None:
        response = await async_client.tool_runtime.with_raw_response.discover_tools(
            tool_group={
                "endpoint": {"uri": "uri"},
                "type": "model_context_protocol",
            },
    ...
    @parametrize
    async def test_streaming_response_discover_tools(self, async_client: AsyncLlamaStackClient) -> None:
        async with async_client.tool_runtime.with_streaming_response.discover_tools(
            tool_group={
                "endpoint": {"uri": "uri"},
                "type": "model_context_protocol",
            },
