...
from ...types.agents import session_create_params
...
class SessionResource(SyncAPIResource):
    ...
    def create(
        ...
        *,
        ...
        return self._post(
            f"/alpha/agents/{agent_id}/session",
            options=make_request_options(
                extra_headers=extra_headers,
                extra_query=extra_query,
                extra_body=extra_body,
                timeout=timeout,
                query=maybe_transform({"session_name": session_name}, session_create_params.SessionCreateParams),
            ),
    ...
    def retrieve(
        ...
        *,
        ...
        return self._get(
            f"/alpha/agents/{agent_id}/session/{session_id}",
            options=make_request_options(
        ...
        return await self._post(
            ...
            options=make_request_options(
                ...
                query=await async_maybe_transform(
                    {"session_name": session_name}, session_create_params.SessionCreateParams
                ),
            ),
            cast_to=SessionCreateResponse,
        )
