...
from ..types import tool_runtime_invoke_params, tool_runtime_discover_params
...
from ..types.shared.tool_def import ToolDef
from ..types.shared_params.tool_group_def import ToolGroupDef
from ..types.shared.tool_invocation_result import ToolInvocationResult
    ...
    def discover(
        ...
        *,
        ...
        return self._post(
            ...
            body=maybe_transform({"tool_group": tool_group}, tool_runtime_discover_params.ToolRuntimeDiscoverParams),
        ...
        *,
        ...
        return self._post(
            ...
            body=maybe_transform(
                ...
                tool_runtime_invoke_params.ToolRuntimeInvokeParams,
            ),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
        ...
        *,
        ...
        return await self._post(
            ...
            body=await async_maybe_transform(
                {"tool_group": tool_group}, tool_runtime_discover_params.ToolRuntimeDiscoverParams
            ),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
