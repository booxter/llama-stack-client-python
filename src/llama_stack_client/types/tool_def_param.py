...
__all__ = ["ToolDefParam", "UserDefinedToolDef", "UserDefinedToolDefParameter", "BuiltInToolDef"]


class UserDefinedToolDefParameter(TypedDict, total=False):
...
class UserDefinedToolDef(TypedDict, total=False):
    description: Required[str]
    ...
    parameters: Required[Iterable[UserDefinedToolDefParameter]]
...
ToolDefParam: TypeAlias = Union[UserDefinedToolDef, BuiltInToolDef]
