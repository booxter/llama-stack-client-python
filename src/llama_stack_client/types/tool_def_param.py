...
__all__ = ["ToolDefParam", "CustomToolDef", "CustomToolDefParameter", "BuiltInToolDef"]


class CustomToolDefParameter(TypedDict, total=False):
...
class CustomToolDef(TypedDict, total=False):
    description: Required[str]
    ...
    parameters: Required[Iterable[CustomToolDefParameter]]
...
ToolDefParam: TypeAlias = Union[CustomToolDef, BuiltInToolDef]
